...
var perlin_octaves :Double = 4; // default to medium smooth
var perlin_amp_falloff :Double = 0.5; // 50% reduction/octave
...
func p5noiseDetail(_ lod: Double, _ falloff:Double) {
  if (lod > 0) {
    perlin_octaves = lod;
  }
  if (falloff > 0) {
